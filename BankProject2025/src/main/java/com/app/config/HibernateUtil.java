		...
		public static SessionFactory getSessionFactory()
		{
			try {
				if(sf==null)
				{
					...
					map.put(Environment.JAKARTA_JDBC_URL, "jdbc:mysql://localhost:3306/bankprojectdatabase");
					...
					mds.addAnnotatedClass(AccountCreationDetails.class);
					mds.addAnnotatedClass(Transact.class);
